...
layout: "single"
exam_code: "312-85"
exam_title: "EC-Council Certified Threat Intelligence Analyst (CTIA)"
exam_level: "intermediate"
exam_status: "active"
exam_category: "EC-Council"
vendor: "eccouncil"
manual: false
guided_slug: "eccouncil-ctia"
---
...
| **Official Page** | [View on EC-Council →](https://www.eccouncil.org/train-certify/certified-threat-intelligence-analyst-ctia/) |
...
1. **Start with Data Collection and Processing** — at 24% it is the heaviest domain; master collection management, feeds and sources, processing, enrichment, and cloud collection first
2. **Learn the frameworks cold** — the Cyber Kill Chain, MITRE ATT&CK (tactics vs techniques), the Diamond Model, and the Pyramid of Pain recur across domains
3. **Know your standards** — be able to contrast STIX (the representation) with TAXII (the transport), and get the Traffic Light Protocol (TLP 2.0) and Admiralty source-reliability scale right
