...
exam_title: "SnowPro Advanced: Data Scientist"
exam_level: "advanced"
exam_status: "active"
exam_category: "Snowflake"
vendor: "snowflake"
manual: false
guided_slug: "snowpro-advanced-data-scientist"
---
...
| **Official Page** | [View on Snowflake →](https://learn.snowflake.com/en/certifications/snowpro-advanced-datascientistC03/) |
...
1. **Lead with model development** — the heaviest domain rewards knowing Snowpark ML, Cortex functions, UDF/UDTF/stored-proc training, hyperparameter tuning, and model interpretation (SHAP, partial dependence) cold
2. **Use our practice exam** — try the 20 free questions first to gauge your readiness for the advanced level
3. **Get hands-on in a trial account** — build feature pipelines, train models with Snowpark ML, log to the Model Registry, and serve predictions with Python UDFs in a real Snowflake account
4. **Think in trade-offs** — the data-scientist exam is about *choosing* (UDF vs SPCS deployment; quantile vs uniform binning; which eval metric for imbalance); read every explanation for the why
5. **Check the official page** — [official exam details](https://learn.snowflake.com/en/certifications/snowpro-advanced-datascientistC03/) always have the latest objectives
