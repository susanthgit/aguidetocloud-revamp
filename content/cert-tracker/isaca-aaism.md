...
layout: "single"
exam_code: "AAISM"
exam_title: "ISACA Advanced in AI Security Management (AAISM)"
exam_level: "advanced"
exam_status: "active"
exam_category: "ISACA"
vendor: "isaca"
manual: false
guided_slug: "isaca-aaism"
---
...
| **Official Page** | [View on ISACA →](https://www.isaca.org/credentialing/aaism) |
...
1. **Know the frameworks cold** — NIST AI RMF (GOVERN/MAP/MEASURE/MANAGE), ISO/IEC 42001, OWASP Top 10 for LLM Apps (2025), MITRE ATLAS, and the EU AI Act's four risk tiers are the backbone of the exam
2. **Master the attack taxonomy** — data poisoning (training-time) vs evasion (inference-time) vs model inversion vs membership inference vs model extraction are the most-confused distinctions
3. **Think like a governor, not an engineer** — the answer is usually a governance principle, risk-treatment decision, or control selection, not a product or a line of code
4. **Use our practice exam** — try the 20 free questions first to gauge your readiness
5. **Check the official page** — [official exam details](https://www.isaca.org/credentialing/aaism) always have the latest objectives
