...
exam_title: "Splunk Certified Cybersecurity Defense Analyst"
exam_level: "intermediate"
exam_status: "active"
exam_category: "Splunk"
vendor: "splunk"
manual: false
guided_slug: "splunk-cybersecurity-defense-analyst"
---
...
| **Official Page** | [View on Splunk →](https://www.splunk.com/en_us/training/certification-track/splunk-certified-cybersecurity-defense-analyst.html) |
...
|--------|--------|-------------|
| Threat and Attack Types, Motivations, and Tactics | 20% | 50 |
| Defenses, Data Sources, and SIEM Best Practices | 20% | 50 |
| Investigation, Event Handling, Correlation, and Risk | 20% | 50 |
| SPL (Search Processing Language) and Efficient Searching | 20% | 50 |
| The Cyber Landscape, Frameworks, and Standards | 10% | 25 |
| Threat Hunting and Remediation | 10% | 25 |
| **Total** | **100%** | **250** |
...
6. **Check the official page** — [official exam details](https://www.splunk.com/en_us/training/certification-track/splunk-certified-cybersecurity-defense-analyst.html) always have the latest objectives
