---
title: "MB-310: Dynamics 365 Finance Functional Consultant - Study Guide & Practice Exam"
description: "Free MB-310 study guide and 250-question practice exam for the Dynamics 365 Finance Functional Consultant Associate certification."
type: "cert-tracker"
layout: "single"
exam_code: "MB-310"
...
manual: false
guided_slug: "mb-310"
images: ["images/og/certs/mb-310.jpg"]
---

## About the MB-310 Exam

> Configure Dynamics 365 Finance - ledgers, journals, cash and bank, accounts receivable and payable, budgeting, subscription billing, and fixed assets.

MB-310 validates the practical configuration and process decisions a Dynamics 365 Finance functional consultant makes across financial management, customer and vendor processes, budget control, and fixed assets. It is a Finance functional exam, not an X++ developer exam and not a Business Central exam.
...
| Resource | Link |
|----------|------|
| Official Exam Page | [Microsoft Learn - MB-310](https://learn.microsoft.com/en-us/credentials/certifications/d365-functional-consultant-financials/) |
| Official Study Guide | [Microsoft Study Guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/mb-310) |
| Free Practice Assessment | [Start Practice Assessment](https://learn.microsoft.com/en-us/credentials/certifications/d365-functional-consultant-financials/practice/assessment?assessment-type=practice&assessmentId=107&practice-assessment-type=certification) |
| Exam Sandbox | [Try the exam interface](https://aka.ms/examdemo) |

## Exam Domains & Weights

| Skill Area | Weight | Practice Qs |
|-----------|--------|-------------|
| Implement financial management | **40-45%** | 105 |
| Implement accounts receivable, credit, collections, and subscription billing | **15-20%** | 43 |
| Implement and manage accounts payable and expenses | **10-15%** | 34 |
| Manage budgeting | **10-15%** | 34 |
| Manage fixed assets | **10-15%** | 34 |
| **Total** | **100%** | **250** |

## Practice Exam - 250 Questions

Prepare with 250 original questions covering all five current MB-310 domains. Every question includes a detailed explanation and maps to the public Microsoft exam objectives.

What you get:

- Exam simulation mode with a timer
...
MB-310 is for Dynamics 365 Finance functional consultants, finance systems analysts, and implementation specialists who translate accounting and operational requirements into Finance configuration. You should understand core accounting concepts and have hands-on experience with ledgers, subledgers, periodic processes, budgeting, and fixed assets in Dynamics 365 Finance.
...
- [MB-800: Dynamics 365 Business Central Functional Consultant](/cert-tracker/mb-800/) - Associate
- [MB-500: Dynamics 365 Finance and Operations Apps Developer](/cert-tracker/mb-500/) - Associate
- [MB-820: Dynamics 365 Business Central Developer](/cert-tracker/mb-820/) - Associate

---

## Quick Links

- [Official Exam Page](https://learn.microsoft.com/en-us/credentials/certifications/d365-functional-consultant-financials/)
- [Microsoft Study Guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/mb-310)
- [Practice Assessment](https://learn.microsoft.com/en-us/credentials/certifications/d365-functional-consultant-financials/practice/assessment?assessment-type=practice&assessmentId=107&practice-assessment-type=certification)
