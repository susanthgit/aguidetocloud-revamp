...
faq:
  ...
  - question: "What's ZAP and is it automatic?"
    answer: "Zero-hour Auto Purge — Defender for Office 365 retroactively removes phishing emails from inboxes after delivery if it later identifies them as malicious (e.g., a URL was clean at delivery but flagged as phishing 10 minutes later). Yes, it's automatic if you have MDO Plan 1 or Plan 2 enabled with Safe Links + Safe Attachments configured. Don't disable it. ZAP is one of the highest-value features in MDO and has saved many tenants from broader compromise."
