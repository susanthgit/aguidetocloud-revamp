...
faq:
  ...
  - question: "When do I have to notify regulators?"
    answer: "GDPR (EU/UK): supervisory authority within 72 hours of becoming aware, if there's risk to individuals' rights. CCPA (California): consumers without unreasonable delay if personal info is breached. HIPAA (US): individuals within 60 days, HHS annually for <500 affected, immediately for ≥500. Get LEGAL involved immediately — the 72-hour clock is shorter than most teams realise, and the trigger is 'aware', not 'investigated'. Most teams blow the deadline because they wait for full forensics. You can notify with partial information; you must update."
