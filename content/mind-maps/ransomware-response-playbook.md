...
faq:
  ...
  - question: "What does 'immutable backup' mean and why does it matter?"
    answer: "Immutable = backups that cannot be modified or deleted for a configured retention period, even by the storage admin. Examples: Azure Storage immutable blobs, AWS S3 Object Lock, dedicated backup services (Azure Backup with immutable vault, Veeam hardened repository). This is the SINGLE most important defense against modern ransomware — attackers explicitly target backups before encrypting production. If your backups can be deleted by a domain admin, they will be. Immutable backups + air-gap (offline copies) + MFA on backup admin = the 3-2-1-1 rule."
