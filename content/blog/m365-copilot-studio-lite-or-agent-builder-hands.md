...
description: "M365 Copilot Studio lite or Agent Builder Hands on Lab | Create Your Own AI Agent in Microsoft 365"
date: 2025-05-07
...
- **How to build custom copilots and AI agents with Copilot Studio**

> **Tip:** Watch the full video above and follow along step by step for the best learning experience.

## Key Topics Covered

Microsoft Copilot Studio (formerly Power Virtual Agents) lets you build custom AI agents — chatbots and copilots that can answer questions, automate tasks, and connect to your business data. No coding experience required.
