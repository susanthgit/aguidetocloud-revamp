...
founder_note: |
  ...
  This post is that framing. Read it once end to end. Then come back to whichever section is in front of you in the week.
...
## images temporarily disabled for local preview - generate via 'npm run build:og:blog' before publish
...
> 🏃 **TL;DR for skimmers**
>
> Seven use-case clusters · 16 individually called-out features (including Cowork) · 10 C-suite role playbooks · 20 named scenarios · 50+ ready-to-paste prompts · first-90-days starter pack · common failure patterns.
>
...
>
> Read your role's section first ([CEO](#r-ceo) · [CFO](#r-cfo) · [COO](#r-coo) · [CIO](#r-cio) · [CHRO](#r-chro) · [CMO](#r-cmo) · [CISO](#r-ciso) · [Board](#r-board) · [Chief of Staff/EA](#r-eoc)). Bookmark the [scenario library](#scenarios) and [prompt library](#prompts).
...
🎯 **The seven executive use-case clusters:**

- [1 · Strategy & Decision Support](#u1)
- [2 · Leadership Communication](#u2)
- [3 · Time & Meetings](#u3)
- [4 · Notebooks for Board Prep](#u4)
...
🧑‍💼 **C-suite role playbooks:**

- [CEO](#r-ceo) · [CFO](#r-cfo) · [COO](#r-coo) · [CIO / CTO](#r-cio) · [CHRO](#r-chro)
- [CMO](#r-cmo) · [CISO](#r-ciso) · [CSO / CRO](#r-cso) · [Board director](#r-board) · [Chief of Staff / EA](#r-eoc)

📋 **Scenario library + prompt library:**

- [20 named executive scenarios](#scenarios) — board pre-read · crisis · QBR · competitor response · M&A · regulator · investor day · annual planning · offsite · town hall · customer escalation · audit committee · risk committee · ESG · transformation · post-merger · public criticism · 1:1s · talent review · CEO transition
- [50+ executive prompt library](#prompts) — CEO · CFO · COO · CIO/CISO · Leadership comms · Thinking-partner packs

🛠 **The patterns and the practice:**

- [Three prompt patterns for executives](#patterns)
- [Trust, governance, accountability — the deeper picture](#trust-deep)
- [What executives must model for the organisation](#model)
- [Common failure patterns and what to do about each](#failures)
- [First 90 days for a new executive — Copilot starter pack](#first90)
- [30-day rhythm for executives](#rhythm)
...
**What it is:** Researcher is a deep-research agent inside Microsoft 365 Copilot. You give it a structured research brief; it goes away for 5–15 minutes and produces a sourced briefing with citations. It is not part of Cowork — it is its own standalone agent, available in the Agent Store.
...
**What it is:** Analyst is a data-analysis agent inside Microsoft 365 Copilot. You give it a question and a data source; it models the answer, shows its workings, and lets you iterate. It is not part of Cowork — it is its own standalone agent, available in the Agent Store.
...
**What it is:** A workspace inside Copilot Chat where you've grounded a set of files (and optionally web links, pages, and other sources). Every prompt you make inside that Notebook is grounded against those sources by default. Notebooks persist — you can come back to one next week and pick up where you left off.
...
**Limit:** Notebooks can hold roughly 20 sources. If you find yourself wanting more, you probably have two different working surfaces emerging — split them into two Notebooks.
...
**What it is:** Copilot Memory can save preferences, facts, and context across sessions — what gets saved depends on your tenant configuration, your admin controls, and your own confirmation. You can also explicitly ask Copilot to remember specific facts.
...
**Important governance note:** Memory persists across sessions but stays inside your tenant. It is not shared across users. Your facts are your facts.
...
3. **Do labels flow through Copilot?** They should — if Copilot generates content from labelled source material, the output should inherit the higher label.
...
In your visible Copilot usage in front of the organisation, *explicitly call out labels*. "I'm using my Board Prep Notebook which is labelled Restricted. Anything I generate from this notebook will inherit that label." This is a small thing that sets a big norm.
...
The patterns are drawn from Microsoft's public Customer Zero deployment (300,000+ employees and external staff), the Synozur Copilot Navigator C-suite series, the Microsoft Executive Use Cases internal asset library, and direct observation across NZ executive engagements over the past six months.
...
<h2 id="prompts">50+ executive prompt library</h2>
...
The trust section above covered the essentials. This section unpacks the deeper picture for executives who are leading the governance conversation in their organisation — and that's most CEOs and CIOs at this point in the adoption curve.
...
There are a hundred different prompt frameworks online. For executives, three patterns will cover most of what you need. Memorise these. The other 97 are for hobbyists.
...
*(For the deeper governance picture — AI Centre of Excellence pattern, five quarterly governance questions, Microsoft Customer Zero lessons, when NOT to use Copilot — see [the deeper section below](#trust-deep).)*
...
**2. AI sceptic without engagement.** The executives who fail their organisations are the ones who say "I prefer the old way" without engaging. The organisation will adopt with or without you. Without you, the adoption pattern will be uneven, ungoverned, and culturally undirected.
...
2. **The [Persona Playbook](/blog/microsoft-365-copilot-by-persona-playbook/)** — for the role-specific patterns your direct reports will be reaching for. Helps you coach them better.
...
- Pick one upcoming board paper or strategy document. Run the Brief-me prompt against it. Compare the brief to your own read after the fact. Calibrate.
- Set up a Notebook for your next significant prep cycle. Three sources is enough to start.
...
**Block 30 minutes a week.** Forever. The executives who get the most out of Copilot are not the ones who took the longest course. They are the ones who blocked 30 minutes a week to try one new thing, and kept doing that for six months.

---

<a id="faq"></a>

*Field guide v2.1 · 2 June 2026 (Cowork section added, Researcher and Analyst un-conflated from Cowork). Microsoft 365 Copilot ships changes monthly — patterns hold, feature names may shift. Spotted something off? [Let me know](/feedback/) and I'll update.*
