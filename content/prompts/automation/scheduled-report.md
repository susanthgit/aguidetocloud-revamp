...
- Start with a manual version to validate the content before automating
- Include a human review step for critical reports
- Version the report so recipients can see what changed
