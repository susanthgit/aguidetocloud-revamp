...
- A decision log prevents "Why did we decide that?" conversations months later
- Keep it in Loop so the whole team has one source of truth
- Add "Include any risks or trade-offs associated with each decision"
