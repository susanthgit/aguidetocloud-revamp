...
- Loop components can be embedded in Teams chats and Outlook emails
- Add "Flag tasks with no owner assigned" to catch gaps
- Update status directly in Loop — everyone sees changes in real time
