...
- Include enough context that someone can discuss the book without reading it
- Highlight counterintuitive findings — those stick in memory
- Add one action item the reader should take based on the book
