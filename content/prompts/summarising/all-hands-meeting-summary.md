...
prompt: 'Create a summary of the all-hands meeting for distribution to the team. Include: (1) Key Announcements — the most important news and updates, (2) Company Performance — any metrics, results, or
  ...
  headers and bullets. Keep it under 500 words.'
platforms:
- m365-copilot
...
- Use immediately after the Teams meeting — Copilot has the full transcript
- In **Teams**, ask Copilot "Summarise the all-hands meeting"
- Perfect for EAs distributing to executives who missed the meeting
- Follow up with "Draft a Teams post sharing this summary with the company channel" 
