...
- In **OneNote**, Copilot can enhance notes directly on the page
- **NotebookLM** excels here — upload lecture slides as sources and ask questions
- Paste raw handwritten-style notes — the messier the input, the more value AI adds
- Follow up with "Create flashcards from these enhanced notes"
