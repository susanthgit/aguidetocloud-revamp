...
- Take your notes freely during the meeting, then run this prompt to tidy up
- Copilot in OneNote can restructure the content directly on the page
- Add "Use bullet points, not paragraphs" for scannable output
