...
- Check if the NDA is mutual or one-way — this significantly changes obligations
- Pay attention to the definition of confidential information — broad definitions are risky
- Note the survival period — obligations often extend beyond agreement termination
