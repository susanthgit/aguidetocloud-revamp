...
- In **Excel**, Copilot can write and insert the formula directly
- Be specific about your data layout: "Column A has dates, Column B has sales amounts"
- Common requests: VLOOKUP/XLOOKUP, SUMIFS, conditional formatting, pivot table setup
- Follow up with "Now create a chart from the results"
