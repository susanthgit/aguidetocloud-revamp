...
- In **Excel**, ensure data has: Name, Department, Location, Start Date, End Date (if left), Role, Level
- Remove personally identifiable information before using external AI tools
- In **M365 Copilot**, the data stays within your organisation's boundary
- Follow up with "Create a visual org chart showing headcount by department" 
