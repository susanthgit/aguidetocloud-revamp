...
- Use M365 Admin Centre usage reports as your data source
- Check for inactive users (no sign-in for 90+ days) first
- Consider seasonal workers and project-based staff before removing licences
