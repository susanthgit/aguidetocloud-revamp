...
- Use with teams to ensure all perspectives are heard
- The Red Hat gives permission to express feelings — that is its power
- End with the Blue Hat to define clear next steps
