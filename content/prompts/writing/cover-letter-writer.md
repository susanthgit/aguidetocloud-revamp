...
prompt: 'Write a cover letter for the [JOB TITLE] position at [COMPANY]. My background: [BRIEF SUMMARY OF EXPERIENCE]. The job posting emphasises: [KEY REQUIREMENTS FROM THE POSTING]. Structure: (1) Opening
  ...
  enthusiastic without being desperate. Avoid clichés like "passionate about" or "team player".'
platforms:
- chatgpt
- claude
- gemini
...
- Paste the actual job posting for the most tailored result
- Replace all placeholders with your real details
- **Claude** excels at natural, non-robotic writing that feels authentic
- Follow up with "Now review my CV against this job posting and suggest improvements"
