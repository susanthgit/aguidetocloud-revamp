...
- In **Copilot Chat (Work mode)**, it can pull booking confirmations from your Outlook inbox
- Paste all confirmation emails below this prompt if using ChatGPT/Claude
- Add "Include restaurant recommendations near each hotel" for extra service
- Follow up with "Create a one-page summary version for printing" 
