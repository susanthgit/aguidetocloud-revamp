...
- In **M365 Copilot (Word)**, reference specific documents: "using data from /Q4 Report.docx"
- Replace [TOPIC] and [AUDIENCE] with specifics — "cloud migration for the CTO"
- Great for EAs preparing documents for their executives
- Follow up with "Add a risk assessment section" for completeness
