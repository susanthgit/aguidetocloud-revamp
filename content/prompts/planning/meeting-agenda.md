...
- Every agenda item needs an expected outcome — discuss is not an outcome
- Send the agenda 24 hours before the meeting with pre-reads
- Allocate time to each item — meetings without timeboxes overrun
