...
- Update at the same time each week for consistency
- Lead with decisions needed — that is what executives read first
- Use traffic lights for instant visual status
