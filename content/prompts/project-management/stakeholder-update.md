...
- Replace [PROJECT NAME] and [TIME PERIOD] with your specifics
- In **Copilot Chat (Work mode)**, it can pull recent activity from Teams channels and emails
- Use RAG status honestly — stakeholders respect transparency over optimism
- Follow up with "Create a 3-slide PowerPoint version for the steering committee" 
