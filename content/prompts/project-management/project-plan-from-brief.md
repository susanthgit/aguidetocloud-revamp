...
- Paste the project brief below this prompt
- In **Word**, reference existing templates: "Based on our standard project plan format"
- Add "Budget ceiling is " and "Timeline is Y months" for realistic constraints
- Follow up with "Export the task list as a table I can paste into Planner/Project" 
