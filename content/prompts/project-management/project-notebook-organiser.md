...
prompt: 'Create a project notebook template for [PROJECT NAME] with these sections: (1) Project Charter — objective, scope, stakeholders, success criteria, (2) Meeting Notes — template for recurring meeting
  ...
  — weekly RAG indicators template. Each section should have a brief description of what goes there.'
platforms:
- m365-copilot
- chatgpt
- claude
...
- In **OneNote**, create each section as a separate tab
- In **Loop**, create as a collaborative workspace the whole team can edit
- Replace [PROJECT NAME] with your project
- Follow up with "Pre-fill the Risk Log with common risks for a [type] project"
