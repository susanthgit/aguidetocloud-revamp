...
- Reference your proposal template by name so Cowork follows your format
- Cowork coordinates across 4 apps — review each deliverable at checkpoints
- Add "Include a case study from a similar client" if you have reference materials
