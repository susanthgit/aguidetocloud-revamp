...
- Cowork will plan the steps and check in at key decision points — review the plan before it executes
- Reference specific files by name so Cowork finds the right data
- This is Cowork's killer use case — a task that normally takes 2-3 hours done autonomously
