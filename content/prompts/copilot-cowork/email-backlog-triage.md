...
- Perfect for returning from leave or after a busy period
- Cowork will show you draft responses before sending — review each one
- Add "Flag anything from [VIP CONTACTS] as highest priority" for personalised triage
