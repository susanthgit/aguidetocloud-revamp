...
- Executives typically want 5-7 slides, not 20 — this prompt solves that
- Add "Keep the data charts but merge the narrative slides" to preserve evidence
- Review the shortened version to ensure no critical slides were cut
