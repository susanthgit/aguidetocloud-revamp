...
- Run this after your slides are finalised — notes should match the content
- Add "Include one engaging question I can ask the audience per section"
- For recorded presentations, add "Write notes as a script I can read naturally"
