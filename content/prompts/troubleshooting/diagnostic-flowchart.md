...
- Test every path in the decision tree before publishing
- Start with the most common cause — solve 80 percent of cases first
- Include time limits — if not resolved in X minutes, escalate
