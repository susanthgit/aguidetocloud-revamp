...
- Start with 5-7 rules — too many becomes hard to maintain
- Always test rules with recent emails before applying
- Keep a catch-all folder for anything that does not match
