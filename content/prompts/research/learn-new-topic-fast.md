...
- Replace [TOPIC] with anything: "Kubernetes", "options trading", "UX design principles"
- In **Copilot Chat (Web mode)**, you get current web-grounded answers
- **ChatGPT** and **Claude** give deeper explanations with more nuance
- Follow up with "Now quiz me on the core concepts to test my understanding"
