...
- Paste the full contract text below this prompt
- **Claude** excels here due to its long context window — can handle very long contracts
- In **Word**, open the contract and use Copilot to review section by section
- ⚠️ Always have a qualified lawyer review AI analysis of contracts — this is a starting point, not legal advice
- Follow up with "Draft a redline response addressing the concerning items" 
