...
- Replace [INDUSTRY] with specifics: "cloud computing", "healthcare SaaS", "electric vehicles"
- **Perplexity** excels here because it searches the web for current data
- In **Copilot Chat (Web mode)**, you get web-grounded results
- Follow up with "Create a SWOT analysis for a company entering this market" 
