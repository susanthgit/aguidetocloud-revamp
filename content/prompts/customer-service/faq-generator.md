...
- Replace [PRODUCT/SERVICE/TOPIC] with your specific subject
- In **Copilot Chat (Work mode)**, reference support ticket data or SharePoint knowledge base
- Use real customer questions from your support inbox for authenticity
- Follow up with "Now create a chatbot decision tree based on these FAQs" 
