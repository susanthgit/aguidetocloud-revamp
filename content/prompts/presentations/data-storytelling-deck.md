...
prompt: 'Create a data storytelling presentation from this data. Structure as: (1) The Hook — start with a surprising finding or trend, (2) The Context — why this data matters and what we were measuring,
  ...
  Avoid data dumps — every number should serve the narrative.'
platforms:
- m365-copilot
- chatgpt
- claude
...
- In **PowerPoint**, reference your Excel data: "Use data from Q3 Sales Report.xlsx"
- The key principle: data tells, stories sell. Lead with insight, not numbers
- Add "Audience has 10 minutes of attention" to keep it focused
- Follow up with "Simplify this for a non-technical audience"
