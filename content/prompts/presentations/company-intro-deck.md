...
prompt: 'Create a company introduction presentation for [AUDIENCE TYPE]. Include: (1) Who We Are — company mission, vision, and values in one impactful slide, (2) By the Numbers — key stats (revenue, employees,
  ...
  notes: suggest colour scheme, imagery style, and layout for each slide.'
platforms:
- m365-copilot
- chatgpt
- claude
...
- Replace [AUDIENCE TYPE] with: "prospective clients", "new employees", "investors"
- In **Copilot Chat (Work mode)**, reference your company SharePoint for accurate data
- Create separate versions for different audiences
- Follow up with "Create a 2-minute elevator pitch script based on this deck"
