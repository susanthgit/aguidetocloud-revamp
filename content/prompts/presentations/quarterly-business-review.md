...
- In **PowerPoint**, use "Create presentation from" and reference your QBR Word doc or data
- Include actual numbers: "Revenue was .3M against a target of .5M"
- Add "Use our company template" if your org has a standard PPT template
- Follow up with "Add speaker notes to each slide" for presentation prep
