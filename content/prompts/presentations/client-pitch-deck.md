...
- Replace [CLIENT NAME] and [INDUSTRY] with specifics
- In **Copilot Chat (Work mode)**, ask it to first research the client from your CRM/emails
- Reference past proposals: "Base the case study on our work with [Similar Client]"
- Follow up with "Customise the language for a CFO audience" or "CTO audience" 
