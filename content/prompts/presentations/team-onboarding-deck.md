...
- Replace [DEPARTMENT] and [COMMON WORKFLOWS] with your team's specifics
- In **Word** first, then convert to PowerPoint for a richer deck
- Add team photos and fun facts to make it personal
- Follow up with "Create a companion OneNote notebook with detailed links and resources" 
