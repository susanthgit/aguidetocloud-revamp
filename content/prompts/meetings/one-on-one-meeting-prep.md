...
prompt: 'Prepare for my upcoming 1:1 meeting with [PERSON]. Create a structured agenda that includes: (1) Check-in — an icebreaker question and general wellbeing check, (2) Their Updates — space for them
  ...
  Allocate time for a 30-minute meeting.'
platforms:
- m365-copilot
- chatgpt
- claude
...
- Replace [PERSON] and [LIST ANY TOPICS] with your specifics
- In **Copilot Chat (Work mode)**, ask it to review recent interactions with this person
- Create a recurring template in **Loop** or **OneNote** for ongoing 1:1 tracking
- Follow up with "Summarise action items from today's 1:1 and send as a follow-up" 
