...
- Replace [ATTENDEES], [TOPIC], and [DATE/TIME] with specifics
- **Only works in Work mode** — Copilot needs access to your org data
- Best used 30 minutes before the meeting for fresh context
- Follow up with "Create a OneNote page with this briefing" to save it
