...
- Works best with structured data that has clear column headers
- Specify what "key metrics" means for your data (revenue, tickets, response time)
- Follow up with "Create a chart showing the most important trend"
