...
- Ensure your date column is formatted as proper dates (not text)
- At least 6 months of data gives better trend detection
- Add "State your confidence level in the forecast" to set expectations
