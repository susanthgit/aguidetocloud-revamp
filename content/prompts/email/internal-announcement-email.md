...
- Replace [TOPIC] with specifics: "office move", "new CEO", "policy change", "system upgrade"
- Match tone to the news: exciting news = enthusiastic, sensitive changes = reassuring
- In **Copilot Chat (Work mode)**, reference related documents for accuracy
- Follow up with "Create a shorter version for Teams/Slack announcement" 
