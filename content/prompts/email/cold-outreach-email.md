...
- Replace [RECIPIENT ROLE], [COMPANY], and [YOUR OFFERING] with specifics
- In **Copilot Chat (Work mode)**, ask it to research the prospect from your CRM first
- Shorter is better — mobile readers decide in 3 seconds
- Follow up with "Write 3 subject line variations" to A/B test
