...
- Replace [TOPIC] and [KEY CONCEPT] with your slide content
- Keep it simple — presentation visuals should support, not distract
- **DALL-E** allows easy editing (erasing and regenerating parts)
- Follow up with "Create matching visuals for my other 3 key slides"
