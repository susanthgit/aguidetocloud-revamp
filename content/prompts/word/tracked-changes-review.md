...
- In Copilot in Word, this works like having an editor review your draft
- Add "This document is for [AUDIENCE]" so suggestions match the reader's level
- Follow up with "Now apply the changes you suggested" to execute the edits
