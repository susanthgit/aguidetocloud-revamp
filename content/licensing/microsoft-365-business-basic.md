...
price: 7
price_note: ""
tagline: "Web apps + Teams + email — the entry-level business plan"
plan_category: "Business (≤300 users)"
badge: ""
ms_official: "https://www.microsoft.com/en-us/microsoft-365/business/microsoft-365-business-basic"
...
faq:
  ...
  - q: "Can I add Copilot to Business Basic?"
    a: "No. Microsoft 365 Copilot requires Business Standard or Premium as a base plan. Business Basic is not eligible for the Copilot add-on."
  - q: "What is the difference between Business Basic and Office 365 E1?"
    a: "Very similar features — both offer web apps, email, and Teams. Business Basic ($7) is cheaper but capped at 300 users. Office 365 E1 ($10) has no user limit and is designed for enterprises."
  - q: "How much storage do I get with Business Basic?"
    a: "Each user gets a 50 GB Exchange mailbox and 1 TB of OneDrive storage. SharePoint offers 1 TB base plus 10 GB per user."
  - q: "Can I upgrade from Basic to Standard later?"
    a: "Yes — it's an instant upgrade in the Microsoft 365 admin centre. No data migration needed. Users keep all email and files."
  - q: "Is Business Basic enough for a small team?"
    a: "If your team only needs email, Teams, and cloud storage — and everyone works in web browsers — yes. But most businesses quickly outgrow it because desktop apps and Copilot eligibility require Standard or Premium."
---
