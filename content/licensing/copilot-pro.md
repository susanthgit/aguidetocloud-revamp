---
title: "Copilot Pro — Features, Pricing & Subscription (2026)"
description: "Microsoft Copilot Pro: $20/month AI in Word, Excel, PowerPoint, Outlook. Subscription details, work-use rules, and how it compares with M365 Copilot."
type: "licensing"
layout: "single"
plan_name: "Microsoft Copilot Pro"
plan_id: "copilot-pro"
price: 20
price_note: "Requires M365 Personal or Family"
tagline: "Premium AI for individuals — Copilot in every Office app, priority model access"
plan_category: "Copilot & AI"
badge: ""
ms_official: "https://www.microsoft.com/en-us/store/b/copilotpro"
m365maps: ""
last_verified: "April 2026"
faq:
  - q: "What is Microsoft Copilot Pro?"
    a: "Copilot Pro is a $20/month personal AI subscription that adds Copilot capabilities to Word, Excel, PowerPoint, Outlook, and OneNote. It requires a Microsoft 365 Personal ($7/mo) or Family ($10/mo) subscription."
  - q: "What is the difference between Copilot Pro and Microsoft 365 Copilot?"
    a: "Copilot Pro ($20/mo) is for individuals — AI in Office apps but no access to business data. Microsoft 365 Copilot ($30/mo) is for organisations — AI grounded on your company's emails, files, meetings, and Teams data via Microsoft Graph."
  - q: "Do I need Microsoft 365 to use Copilot Pro?"
    a: "Yes. Copilot Pro requires Microsoft 365 Personal ($7/month) or Microsoft 365 Family ($10/month) to unlock AI features in desktop Office apps. Without a qualifying subscription, Copilot Pro only works in the web chat."
  - q: "Can I use Copilot Pro for work?"
    a: "Technically yes, but it cannot access your organisation's data (emails, SharePoint, Teams). It only works with your personal files. For work use, your IT admin should deploy Microsoft 365 Copilot ($30/user/month) instead."
  - q: "Is Copilot Pro worth $20 a month?"
    a: "If you heavily use Word, Excel, and PowerPoint for personal or freelance work, the drafting and analysis features can save hours per week. If you only use web email and basic documents, the free Copilot Chat may be enough."
  - q: "Can my company buy Copilot Pro for employees?"
    a: "No. Copilot Pro is a personal consumer subscription. For business and enterprise use, deploy Microsoft 365 Copilot ($30/user/month) which requires M365 E3, E5, Business Standard, or Business Premium."
---
