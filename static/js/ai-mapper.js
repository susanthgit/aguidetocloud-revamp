...
(function() {
  ...
  function openModal(serviceId) {
    ...
    var capsHTML = '<div class="aimap-modal-caps">' + caps.map(function(c) {
      return '<div class="aimap-modal-cap-row"><span class="aimap-modal-cap-label">' + c.label + '</span>' +
        '<div class="aimap-modal-cap-bar"><div class="aimap-modal-cap-fill" style="width:' + ((c.val||0)*20) + '%;background:' + (c.val >= 4 ? '#38BDF8' : c.val >= 2 ? '#fbbf24' : '#666') + '"></div></div>' +
  ...
  function capBar(val) {
    ...
    var color = val >= 4 ? '#38BDF8' : val >= 2 ? '#fbbf24' : '#666';
